namespace OSAE
{
    ...
    public class OSAEMethodManager
    {
        ...
        public static List<OSAEMethod> GetMethodsInQueue()
        {
            ...
            using (MySqlCommand command = new MySqlCommand())
            {
                command.CommandText = "SELECT method_queue_id, object_name, address, method_name, method_label, parameter_1, parameter_2, object_owner, from_object FROM osae_v_method_queue WHERE (object_owner IS NULL OR object_owner != 'SYSTEM') ORDER BY entry_time";

...
//#endif
            ...
            try
            {
                ...
                ObjectStateManager.ObjectStateSet("SERVICE-" + osae.ComputerName, "ON", "OSAE Service");
            }
            catch (Exception ex)
            {
                ...
                try
                {
                    ...
                    if (goodConnection)
                    {
                        ...
                        else
                        {
                            ...
                            ObjectPopertiesManager.ObjectPropertySet(plugin.PluginName, "Computer Name", osae.ComputerName, sourceName);

...
CALL osae_sp_object_type_property_add('Control Type','String','','USER CONTROL CHANGE THIS',0);
CALL osae_sp_object_type_property_add('Object Name','String','','USER CONTROL CHANGE THIS',0);
CALL osae_sp_object_type_property_add('X','Integer','100','USER CONTROL CHANGE THIS',0);
CALL osae_sp_object_type_property_add('Y','Integer','100','USER CONTROL CHANGE THIS',0);
CALL osae_sp_object_type_property_add('ZOrder','Integer','1','USER CONTROL CHANGE THIS',0);

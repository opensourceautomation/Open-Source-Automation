...
CALL osae_sp_object_type_property_add('METER READER','Version','String','','',0);
CALL osae_sp_object_type_property_add('METER READER','Author','String','','',0);
CALL osae_sp_object_type_property_add('METER READER','Trust Level','Integer','','90',0);

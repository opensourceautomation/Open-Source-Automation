...
CALL osae_sp_object_type_method_add ('CUSTOM1','Custom1','IP CAMERA','','','','');
CALL osae_sp_object_type_method_add ('CUSTOM2','Custom1','IP CAMERA','','','','');
CALL osae_sp_object_type_method_add ('CUSTOM3','Custom1','IP CAMERA','','','','');
CALL osae_sp_object_type_method_add ('CUSTOM4','Custom1','IP CAMERA','','','','');
CALL osae_sp_object_type_method_add ('CUSTOM5','Custom1','IP CAMERA','','','','');
CALL osae_sp_object_type_method_add ('CUSTOM6','Custom1','IP CAMERA','','','','');
CALL osae_sp_object_type_method_add ('SNAPSHOT','Snapshot','IP CAMERA','','','','');
CALL osae_sp_object_type_property_add  ('Height','Integer','','IP CAMERA',300);
CALL osae_sp_object_type_property_add  ('Width','Integer','','IP CAMERA',400);
...
CALL osae_sp_object_type_property_add ('CUSTOM1','String','','IP CAMERA',0);
CALL osae_sp_object_type_property_add ('CUSTOM2','String','','IP CAMERA',0);
CALL osae_sp_object_type_property_add ('CUSTOM3','String','','IP CAMERA',0);
CALL osae_sp_object_type_property_add ('CUSTOM4','String','','IP CAMERA',0);
CALL osae_sp_object_type_property_add ('CUSTOM5','String','','IP CAMERA',0);
CALL osae_sp_object_type_property_add ('CUSTOM6','String','','IP CAMERA',0);
...
namespace OSAE.IPCamII
{
    public class IPCamII : OSAEPluginBase
    {
        ...
        public override void ProcessCommand(OSAEMethod method)
        {
            ...
            CUSTOM1= OSAEObjectPropertyManager.GetObjectPropertyValue(camName, "CUSTOM2").Value;
            CUSTOM1= OSAEObjectPropertyManager.GetObjectPropertyValue(camName, "CUSTOM3").Value;
            CUSTOM1= OSAEObjectPropertyManager.GetObjectPropertyValue(camName, "CUSTOM4").Value;
            CUSTOM1= OSAEObjectPropertyManager.GetObjectPropertyValue(camName, "CUSTOM5").Value;
            CUSTOM1= OSAEObjectPropertyManager.GetObjectPropertyValue(camName, "CUSTOM6").Value;

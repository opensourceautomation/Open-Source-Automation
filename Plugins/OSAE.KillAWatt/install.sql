...
CALL osae_sp_object_type_property_add('KILLAWATT','Port', 'Integer', '', '', 0);
CALL osae_sp_object_type_property_add('KILLAWATT','Interval', 'Integer', '', '', 0);
CALL osae_sp_object_type_property_add('KILLAWATT','Computer Name', 'String', '', '', 0);
CALL osae_sp_object_type_property_add('KILLAWATT','VREF', 'Integer', '', '', 0);
...
CALL osae_sp_object_type_property_add('KILLAWATT MODULE','RSSI', 'Integer', '', '', 0);

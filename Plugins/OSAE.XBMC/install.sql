...
CALL osae_sp_object_type_property_add('XBMC','Trust Level','Integer','','90',0);
CALL osae_sp_object_type_property_add('XBMC','Version','String','','',0);
CALL osae_sp_object_type_property_add('XBMC','Author','String','','',0);
...
CALL osae_sp_object_type_property_add('XBMC SYSTEM','Port','Integer','','0',0);

...
CALL osae_sp_object_type_state_add ('RFXCOM','ON','Running');
CALL osae_sp_object_type_state_add ('RFXCOM','OFF','Stopped');
CALL osae_sp_object_type_event_add ('RFXCOM','ON','Started');
CALL osae_sp_object_type_event_add ('RFXCOM','OFF','Stopped');
CALL osae_sp_object_type_method_add ('RFXCOM','ON','Start','','','','');
CALL osae_sp_object_type_method_add ('RFXCOM','OFF','Stop','','','','');
CALL osae_sp_object_type_property_add('RFXCOM','Port', 'Integer', '','', 0);
CALL osae_sp_object_type_property_add('RFXCOM','Learning Mode', 'Boolean', '','', 0);
...
CALL osae_sp_object_type_property_add('OS TEMP SENSOR','Temperature', 'String', '','', 0);
CALL osae_sp_object_type_property_add('OS TEMP SENSOR','Battery', 'String', '','', 0);
...
CALL osae_sp_object_type_property_add('OS RAIN METER','Rain Rate', 'String', '','', 0);
CALL osae_sp_object_type_property_add('OS RAIN METER','Total Rain', 'String', '','', 0);
CALL osae_sp_object_type_property_add('OS RAIN METER','Battery', 'String', '','', 0);
...
CALL osae_sp_object_type_property_add('HUMIDITY METER','Humidity', 'String', '','', 0);
CALL osae_sp_object_type_property_add('HUMIDITY METER','Status', 'String', '','', 0);
CALL osae_sp_object_type_property_add('HUMIDITY METER','Battery', 'String', '','', 0);
...
CALL osae_sp_object_type_property_add('TEMP HUM METER','Temperature', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM METER','Humidity', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM METER','Status', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM METER','Battery', 'String', '','', 0);
...
CALL osae_sp_object_type_property_add('TEMP HUM BARO METER','Temperature', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM BARO METER','Humidity', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM BARO METER','Status', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM BARO METER','Barometer', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM BARO METER','Forcast', 'String', '','', 0);
CALL osae_sp_object_type_property_add('TEMP HUM BARO METER','Battery', 'String', '','', 0);
...
CALL osae_sp_object_type_property_add('WIND SENSOR','Direction', 'String', '','', 0);
CALL osae_sp_object_type_property_add('WIND SENSOR','Average Speed', 'String', '','', 0);
CALL osae_sp_object_type_property_add('WIND SENSOR','Wind Gust', 'String', '','', 0);
CALL osae_sp_object_type_property_add('WIND SENSOR','Temperature', 'String', '','', 0);
CALL osae_sp_object_type_property_add('WIND SENSOR','Windchill', 'String', '','', 0);
CALL osae_sp_object_type_property_add('WIND SENSOR','Battery', 'String', '','', 0);
...
CALL osae_sp_object_type_property_add('UV SENSOR','Temperature', 'String', '','', 0);
CALL osae_sp_object_type_property_add('UV SENSOR','Level', 'String', '','', 0);
CALL osae_sp_object_type_property_add('UV SENSOR','Description', 'String', '','', 0);
CALL osae_sp_object_type_property_add('UV SENSOR','Battery', 'String', '','', 0);

CALL osae_sp_object_type_add ('CURRENT METER','Current Meter','','',0,0,0,1);
CALL osae_sp_object_type_property_add('CURRENT METER','Count', 'String', '', '',  0);
CALL osae_sp_object_type_property_add('CURRENT METER','Channel 1', 'String', '','', 0);
CALL osae_sp_object_type_property_add('CURRENT METER','Channel 2', 'String', '','', 0);
CALL osae_sp_object_type_property_add('CURRENT METER','Channel 3', 'String', '','', 0);

CALL osae_sp_object_type_add ('SCALE','Current Meter','','',0,0,0,1);
CALL osae_sp_object_type_property_add('SCALE','Weight', 'String', '','',  0);
...
CALL osae_sp_object_type_property_add ('AC DIMMER SWITCH','Level','String','','',1);
...
CALL osae_sp_object_type_property_add ('HEU DIMMER SWITCH','Level','String','','',1);
...
CALL osae_sp_object_type_property_add ('ANSLUT DIMMER SWITCH','Level','String','','',1);
...
CALL osae_sp_object_type_property_add ('LIGHTWAVERF DIMMER SWITCH','Level','String','','',1);

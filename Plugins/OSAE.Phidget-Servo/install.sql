...
CALL osae_sp_object_type_property_add ('PHIDGET-SERVO','Attached','Boolean','',0);
...
CALL osae_sp_object_type_property_add ('PHIDGET-SERVO','Position','Integer','',0);
CALL osae_sp_object_type_property_add ('PHIDGET-SERVO','Default Position','Integer','',0);

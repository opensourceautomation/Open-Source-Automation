            ...
            If IsNothing(oObject) Then
                If gLearning.ToUpper = "TRUE" Then
                    If gDevice.Device_Type = "X10_SECURITY_DS10" Then
                        ...
                        OSAEObjectManager.ObjectAdd("X10-" & gDevice.Device_Code, "", "Unknown DS10A found by W800RF", "BINARY SENSOR", gDevice.Device_Code, "", 30, True)
                    Else
                        ...
                        OSAEObjectManager.ObjectAdd("X10-" & gDevice.House_Code & gDevice.Device_Code, "", "Unknown X10 found by W800RF", "BINARY SENSOR", gDevice.House_Code & gDevice.Device_Code, "", 30, True)
                    End If
                End If
            Else

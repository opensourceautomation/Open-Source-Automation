...
#Region "Methods"
    ' This subroutine invokes a thread to perform an asynchronous read. This routine should not be called directly, but is used by the class.
    Public Sub _R()
        Dim iRet As Integer = Read(miTmpBytes2Read)
    End Sub
    ' This subroutine invokes a thread to perform an asynchronous write. This routine should not be called directly, but is used by the class.
    Public Sub _W()
        Write(mabtTmpTxBuf)
    End Sub
    ' This subroutine uses another thread to read from the Comm Port. It raises RxCompleted when done. It reads an integer.
    Public Overloads Sub AsyncRead(ByVal Bytes2Read As Integer)
        ...
        moThreadTx.Start()
    End Sub
    ' This subroutine uses another thread to write to the Comm Port. It raises TxCompleted when done. It writes an array of bytes.
    Public Overloads Sub AsyncWrite(ByVal Buffer() As Byte)
        ...
        moThreadTx.Start()
    End Sub
    ' This subroutine uses another thread to write to the Comm Port. It raises TxCompleted when done. It writes a string.
    ...
    Public Overloads Sub Open()
        ...
        End If
    End Sub
    ' This subroutine opens and initializes the Comm Port (overloaded to support parameters).
    ...
    Private Sub pSetTimeout()
        ...
        End If
    End Sub
    ' This function returns an integer specifying the number of bytes read from the Comm Port. It accepts a parameter specifying the number of desired bytes to read.
    ...
    Public Overloads Sub Write(ByVal Buffer As Byte())
        ...
        End If
    End Sub
    ' This subroutine writes the passed string to the Comm Port to be written.
